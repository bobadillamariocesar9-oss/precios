-- ============================================================
-- Script DDL generado desde las entidades JPA
-- Orden: stores → category → products (products depende de stores)
-- Ejecutar en psql o DBeaver sobre la base apiPrecios
-- ============================================================
